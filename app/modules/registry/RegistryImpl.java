...
public class RegistryImpl implements IRegistry {
     ...
     */
    @Override
    public IMappingDao getMappingOneOneDao() {
        return getBean("DAO_MAPPING_ONE_ONE", IMappingDao.class);
    }
     ...
     */
    @Override
    public IMappingDao getMappingManyOneDao() {
        return getBean("DAO_MAPPING_MANY_ONE", IMappingDao.class);
    }
     ...
     */
    @Override
    public IMappingDao getMappingManyManyDao() {
        return getBean("DAO_MAPPING_MANY_MANY", IMappingDao.class);
    }
}
